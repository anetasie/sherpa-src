...
# !!3
toolname="lev3_f2cratio"

# set up list of tests
# !!4
alltests="lev3_f2cratio1"
...
do
  ...
  # Set up file names
  specfile="$INDIR/acisf00635_000N001_r0001_pha3.fits"
  #outfile="$OUTDIR/acisf00635_000N001_r0001_mdlratio3.par"
  ...
  case ${testid} in
    # !!1
      lev3_f2cratio1 ) test_string="lev3_f2cratio.py specfile=$specfile \
	  outfile=$outfile e_band=\"$e_band\" nH_gal=\"$nh_gal\""
      	  ;;
