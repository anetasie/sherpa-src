...
# !!3
toolname="lev3_specfit"

# set up list of tests
# !!4
alltests="lev3_specfit1"
...
do
  ...
  # Set up file names
  phafile="$INDIR/acisf00635_000N001_r0001_pha3.fits"
  #outfile="$OUTDIR/acisf00635_000N001_r0001_mdls3.par"
  outfile="$OUTDIR/${toolname}_${testid}.param.txt"

  e_band=".5,7"
  e_range=".5,7"

  nh_gal=`pget $INDIR/acisf00635_000N001_r0001_nh3.par nh_gal`
  ...
  case ${testid} in
    # !!1
      lev3_specfit1 ) test_string="lev3_specfit.py phafile=$phafile \
	  outfile=$outfile e_band=\"$e_band\" e_range=\"$e_range\" \
          nH=\"$nh_gal\""
      	  ;;
