...
do
  ...
  # Set up file names
  imgfile="$INDIR/acisf00635_000N001_r0001b_img3.fits"
  psffile="$INDIR/acisf00635_000N001_r0001b_psf3.fits"

  evtfile="$INDIR/acisf00635_000N001_r0001b_regevt3.fits"
  rayfile="$INDIR/acisf00635_000N001_r0001b_projrays3.fits"

  regfile="$INDIR/acisf00635_000N001_r0001_reg3.fits"
  ...
  case ${testid} in
    # !!1
      lev3_mho1 ) test_string="lev3_mho.py evtfile=$evtfile outfile=$outfile \
              x0=\"4052.91\" y0=\"3209.61\" srcsize=\"19.8898\" \
              sigmafactor=\"0.355\""
      	  ;;
    # !!2
      lev3_mho2 ) test_string="lev3_mho.py evtfile=$rayfile outfile=$outfile \
              x0=\"4052.91\" y0=\"3209.61\" srcsize=\"5.16159\" \
              sigmafactor=\"1.0\""
      	  ;;
  esac
