...
class test_optmethods(SherpaTestCase):
    ...
    def tst_all( self, name, fct_fval, fct_fvec, fmin, x0, xmin, xmax,
                 iprint=False ):
        self.tst( optfcts.neldermead, name + self.nm, fct_fval, fmin,
                  x0, xmin, xmax, iprint=iprint )
        self.tst( optfcts.montecarlo,  name + self.mc , fct_fval, fmin,
                  x0, xmin, xmax, iprint=iprint, maxfev=8192*len(x0) )
        self.tst( optfcts.lmdif, name + self.lm, fct_fvec, fmin,
                  x0, xmin, xmax, iprint=iprint )
    ...
    def test_rosenbrock(self):
        ...
        self.tst_all( name, _tstoptfct.rosenbrock_fct, _tstoptfct.rosenbrock,
                      fmin, x0, xmin, xmax )
    ...
    def test_powell_badly_scaled(self):
        ...
        self.tst( optfcts.neldermead, name + self.nm,
                  _tstoptfct.powell_badly_scaled_fct, fmin, x0, xmin, xmax )
    ...
    def test_brown_badly_scaled(self):
        ...
        npar = 2
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.brown_badly_scaled_fct,
                       _tstoptfct.brown_badly_scaled,
                      fmin, x0, xmin, xmax )        
    ...
    def test_beale(self):
        ...
        npar = 2
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name,_tstoptfct.beale_fct, _tstoptfct.beale,
                      fmin, x0, xmin, xmax )
    ...
    def test_jennrich_sampson(self):
        ...
        npar = 2
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.jennrich_sampson_fct,
                      _tstoptfct.jennrich_sampson, fmin, x0, xmin, xmax )

    def test_helical_valley(self):
        name = 'helical_valley'
        npar = 3
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.helical_valley_fct,
                      _tstoptfct.helical_valley, fmin, x0, xmin, xmax )
        
    def test_bard(self):
        name = 'bard'
        npar = 3
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.bard_fct, _tstoptfct.bard,
                      fmin, x0, xmin, xmax )
    ...
    def test_gulf_research_development(self):
        ...
        npar = 3
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.gulf_research_development_fct,
                      _tstoptfct.gulf_research_development,
                      fmin, x0, xmin, xmax )
    ...
    def test_box3d(self):
        ...
        npar = 3
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.box3d_fct, _tstoptfct.box3d,
                      fmin, x0, xmin, xmax )
    ...
    def test_wood(self):
        ...
        npar = 4
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst( optfcts.neldermead, name + self.nm, _tstoptfct.wood_fct,
                  fmin, x0, xmin, xmax )
        self.tst( optfcts.montecarlo, name + self.mc, _tstoptfct.wood_fct,
                  fmin, x0, xmin, xmax )
    ...
    def test_kowalik_osborne(self):
        ...
        npar = 4
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.kowalik_osborne_fct,
                      _tstoptfct.kowalik_osborne, fmin, x0, xmin, xmax )

    def test_brown_dennis(self):
        name = 'brown_dennis'
        npar = 4
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.brown_dennis_fct,
                      _tstoptfct.brown_dennis, fmin, x0, xmin, xmax )
    ...
    #    npar = 11
    #    x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
    #    self.tst_all( name, _tstoptfct.osborne2_fct,
    #                  _tstoptfct.osborne2, fmin, x0, xmin, xmax )

    def test_watson(self):
        name = 'watson'
        npar = 6
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst( optfcts.neldermead, name + self.nm, _tstoptfct.watson_fct,
                  fmin, x0, xmin, xmax )
        self.tst( optfcts.montecarlo, name + self.mc, _tstoptfct.watson_fct,
                  fmin, x0, xmin, xmax )
    ...
    #    x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        ...
        #self.tst( optfcts.neldermead, name + self.nm, _tstoptfct.penaltyII_fct,
        #          fmin, x0, xmin, xmax )
    #    self.tst( optfcts.montecarlo, name + self.mc, _tstoptfct.penaltyII_fct,
    #              fmin, x0, xmin, xmax )
    ...
    def test_variably_dimensioned(self):
        ...
        npar = 5
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.variably_dimensioned_fct,
                      _tstoptfct.variably_dimensioned, fmin, x0, xmin, xmax )
    ...
    def test_trigonometric(self):
        ...
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst( optfcts.neldermead, name + self.nm,
                  _tstoptfct.trigonometric_fct, fmin, x0, xmin, xmax )
        self.tst( optfcts.montecarlo, name + self.mc,
                  _tstoptfct.trigonometric_fct, fmin, x0, xmin, xmax )
    ...
    def test_discrete_boundary(self):
        ...
        npar = 5
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.discrete_boundary_fct,
                      _tstoptfct.discrete_boundary, fmin, x0, xmin, xmax )
            
    def test_discrete_integral(self):
        name = 'discrete_integral'
        npar = 5
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.discrete_integral_fct,
                      _tstoptfct.discrete_integral, fmin, x0, xmin, xmax )
            
    def test_broyden_tridiagonal(self):
        name = 'broyden_tridiagonal'
        npar = 16
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.broyden_tridiagonal_fct,
                      _tstoptfct.broyden_tridiagonal, fmin, x0, xmin, xmax )
            
    def test_broyden_banded(self):
        name = 'broyden_banded'
        npar = 18
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.broyden_banded_fct,
                      _tstoptfct.broyden_banded, fmin, x0, xmin, xmax )
            
    def test_linear_fullrank(self):
        name = 'linear_fullrank'
        npar = 18
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.linear_fullrank_fct,
                      _tstoptfct.linear_fullrank, fmin, x0, xmin, xmax )
            
    def test_linear_fullrank1(self):
        name = 'linear_fullrank1'
        npar = 15
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.linear_fullrank1_fct,
                      _tstoptfct.linear_fullrank1, fmin, x0, xmin, xmax )
            
    def test_linear_fullrank0cols0rows(self):
        name = 'linear_fullrank0cols0rows'
        npar = 13
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.linear_fullrank0cols0rows_fct,
                      _tstoptfct.linear_fullrank0cols0rows, fmin, x0,
                      xmin, xmax )
    ...
    def test_chebyquad(self):
        ...
        npar = 11
        x0, xmin, xmax, fmin = _tstoptfct.init( name, npar )
        self.tst_all( name, _tstoptfct.chebyquad_fct,
                      _tstoptfct.chebyquad, fmin, x0, xmin, xmax )
def tstme():
